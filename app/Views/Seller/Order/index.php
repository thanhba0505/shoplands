...
<div class="text-center bg-gray-200 py-3 mt-5 text-lg font-medium">
    Lọc
</div>

<div class="overflow-x-auto">
    <table class="table-auto w-full mt-5 border-collapse border border-gray-300 text-sm">
        <thead>
            <tr class="bg-gray-200 text-center font-semibold">
                <th class="border border-gray-300 px-4 py-2">Sản phẩm</th>
                <th class="border border-gray-300 px-4 py-2">Doanh thu đơn hàng</th>
                <th class="border border-gray-300 px-4 py-2">Đơn vị vận chuyển</th>
                <th class="border border-gray-300 px-4 py-2">Thời gian tạo đơn</th>
        ...
        <tbody>
            <?php for ($i = 0; $i < 5; $i++): ?>
                ...
                <tr class="bg-gray-100">
                    <td colspan="3" class="border border-gray-300 px-4 py-2 font-bold">Tên người mua</td>
                    <td colspan="3" class="border border-gray-300 px-4 py-2 text-right">Mã đơn hàng: <?= rand(10000000, 99999999) ?></td>
                </tr>
                <tr class="text-center">
                    <td class="border border-gray-300 px-4 py-2">
                        ...
                        <?php for ($j = 0; $j < $limit; $j++): ?>
                            <div class="flex justify-between items-center gap-x-1 <?= $j != $limit - 1 ? 'mb-3' : ''; ?>">
                                <img src="<?= BASE_URL ?>/public/uploads/img/cap-sac.webp" alt="" class="w-10 h-10 border border-gray-300">
                    ...
                    <td class="border border-gray-300 px-4 py-2">180.000đ</td>
                    <td class="border border-gray-300 px-4 py-2">Giao hàng nhanh</td>
                    <td class="border border-gray-300 px-4 py-2">01/01/2022</td>
                    <td class="border border-gray-300 px-4 py-2">Đang đóng gói</td>
                    <td class="border border-gray-300 px-4 py-2">
                        <a href="<?= BASE_URL ?>/seller/orders/detail" class="text-blue-500 hover:underline">Chi tiết</a>
                        <?php
                        $trang_thai = $page ?? null;
                        switch ($trang_thai) {
                            case 'pending':
                                echo '<a href="' . BASE_URL . '/seller/orders/detail" class="ml-2 text-green-500 hover:underline">Xác nhận</a>';
                                break;
                            case 'packing':
                                echo '<a href="' . BASE_URL . '/seller/orders/detail" class="ml-2 text-green-500 hover:underline">Đã đóng gói</a>';
                                break;
                            case 'packed':
                                echo '<a href="' . BASE_URL . '/seller/orders/detail" class="ml-2 text-green-500 hover:underline">Đã giao</a>';
                                break;
                            case 'returned':
                                echo '<a href="' . BASE_URL . '/seller/orders/detail" class="ml-2 text-yellow-500 hover:underline">Chấp nhận</a>';
                                echo '<a href="' . BASE_URL . '/seller/orders/detail" class="ml-2 text-red-500 hover:underline">Từ chối</a>';
                                break;
                            default:
                                break;
                        }

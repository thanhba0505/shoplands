                ...
                <tbody>
                    ...
                    <?php for ($i = 0; $i < 5; $i++): ?>
                        ...
                        <tr style="border-left: none; border-right: none">
                            <td colspan="6" style="padding: 8px 0;"></td>
                        </tr>
                        ...
                        <tr class="table-color-1-opacity-3 table-border-1 border-width-2 font-size-2">
                            ...
                            <td colspan="3" class="text-right" style="border-left: none;">Mã đơn hàng: <?= rand(10000000, 99999999) ?></td>
                        </tr>
                            ...
                            <td width="450px">
                                ...
                                <?php for ($j = 0; $j < $limit; $j++): ?>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center <?= $j != $limit - 1 ? 'mb-3' : ''; ?>">
                                        ...
                                        <div class="text-ellipsis-2 text-left" style=" width: 60%; height: 36px; max-width: 200px">20w Sạc Nhanh Thông Minh USB C PD US Cắm Dữ Liệu Sạc Nhanh 1Meter PD Cáp Adapter USB-C Dây Cắm</div>
                                        <div class="" style="">x<?= rand(1, 3) ?></div>
                                        <div style="max-width: 100px;">Cáp, dây sạc,álkf alksjfklasjf</div>
                                    </div>

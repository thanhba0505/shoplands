...
<div id="tab-promotion-content" class="flex space-x-1 mt-4 border-b text-center text-sm">
    <?php foreach ($listPromotion as $key => $label): ?>
        <div data-tab-promotion="<?= Util::encodeHtml($key) ?>" class="py-2 px-2 select-none cursor-pointer">
...
<div class="overflow-x-auto">
    <table class="table-auto w-full mt-5 border-collapse text-sm">
        ...
        <!-- Nội dung -->
        <tbody id="promotion-content"></tbody>

...
<div id="tab-admin-content" class="flex space-x-1 mt-4 border-b text-center text-sm">
    <?php foreach ($listAdmin as $key => $label): ?>
        <div data-tab-admin="<?= Util::encodeHtml($key) ?>" class="py-2 px-2 select-none cursor-pointer">

        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex justify-between items-center">
                <div class="w-80 max-w-md">
                    <form action="<?= Redirect::product()->getUrl() ?>" method="GET" onsubmit="removeEmptyFields(this)">
                        <?= Other::inputField(['name' => 'search', 'value' => isset($filter['search']) ? $filter['search'] : '', 'placeholder' => 'Tìm kiếm...', 'autocomplete' => 'off'], 'search') ?>
                    </form>
                </div>

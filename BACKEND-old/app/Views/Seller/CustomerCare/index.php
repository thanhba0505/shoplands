...
<div id="tab-customer-care-content" class="flex space-x-1 mt-4 border-b text-center text-sm">
    <?php foreach ($listCustomerCare as $key => $label): ?>
        <div data-tab-customer-care="<?= Util::encodeHtml($key) ?>" class="py-2 px-2 select-none cursor-pointer">
...
<div class="overflow-x-auto">
    <table class="table-auto w-full mt-5 border-collapse text-sm">
        ...
        <!-- Nội dung -->
        <tbody id="customer-care-content"></tbody>

...
<div id="tab-product-content" class="flex space-x-1 mt-4 border-b text-center text-sm">
    <?php foreach ($listProductStatus as $key => $label): ?>
        <div data-tab-product="<?= Util::encodeHtml($key) ?>" class="py-2 px-2 select-none cursor-pointer">
